...
public class Salary {
    ...
    @Size(max = 45, message = "Description must be max 45 characters")
    ...
    public Salary(String type, Double value, LocalDate date, String description, Users usersId, Currency currencyId) {
        this.type = type;
        this.value = value;
        this.date = date;
